...
import ar.edu.unlam.pb2.clases.Bicicleta;
import ar.edu.unlam.pb2.clases.Mapa;
import ar.edu.unlam.pb2.clases.MedioTransporte;
import ar.edu.unlam.pb2.clases.Moto;
import ar.edu.unlam.pb2.clases.Tren;
...
public class TestCases {
	...
	public void  queSePuedanIncorporarDistintosVehiculos() throws ColitionException{		
			...
			assertFalse(actual.hayCoalición(actual));
	}
	...
	public void  queChoquenDosVehiculos() throws ColitionException {	
		...
		assertTrue(actual.hayCoalición(unAuto));
